...
/**
 * 导入合同请求：主数据字段与 {@link com.yy.agent.contract.domain.Contract} 对齐，并携带可选条款列表。
 * <p>
 * {@code type} 支持枚举名、英文别名或中文展示名（见 {@link com.yy.agent.contract.domain.ContractType#fromFlexible(String)}）；
 * {@code riskTier} 支持枚举名或中文（见 {@link com.yy.agent.contract.domain.RiskSeverity#fromDisplayName(String)}）。
 *
